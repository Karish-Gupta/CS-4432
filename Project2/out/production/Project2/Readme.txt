...
This will bring up the prompt "Program is ready and waiting for user command", as in the base homework.
Enter "Mergesort"
Then it will prompt you for the number of buffers.
Enter an integer greater than or equal to 11.
...
The program will prompt you again if you want to run something, however,
it is best to delete all PhaseOne.txt files and the final merged file before running this again.

Additionally, when testing ensure that the path constant is set toi your PC's respective path.
